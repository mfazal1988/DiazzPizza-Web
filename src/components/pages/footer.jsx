            ...
            <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">Mountain View Road, Colombo 15, Sri Lanka</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+94 3929 210</span></a></li>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <p>
                    ...
                    Copyright ©
                    <script>document.write(new Date().getFullYear());</script>2024 All rights reserved | This Website made by ICBT MSc IT Students <i class="icon-heart" aria-hidden="true"></i>
